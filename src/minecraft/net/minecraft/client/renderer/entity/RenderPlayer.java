...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!entity.isUser() || this.renderManager.renderViewEntity == entity)
        {
            ...
            if(Client.getModuleManager().isModuleOn(new PlayerESP()) && entity != Minecraft.getMinecraft().player) {
            	GlStateManager.disableDepth();
            	GlStateManager.disableLighting();
            	GlStateManager.disableTexture2D();
            	
            	float r = (float)(this.getTeamColor(entity) >> 16 & 255) / 255.0F;
            	float g = (float)(this.getTeamColor(entity) >> 8 & 255) / 255.0F;
            	float b = (float)(this.getTeamColor(entity) >> 0 & 255) / 255.0F;
            ...
            if(entity == Minecraft.getMinecraft().player) {
                super.doRender2(entity, x, d0, z, entityYaw, partialTicks);
            }else {
                super.doRender(entity, x, d0, z, entityYaw, partialTicks);
            }
