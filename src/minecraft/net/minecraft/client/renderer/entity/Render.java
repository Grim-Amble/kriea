...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (d0 <= (double)(maxDistance * maxDistance) || Client.getModuleManager().isModuleOn(new Nametags()))
        {
            ...
            if(Client.getModuleManager().isModuleOn(new Nametags()) && entityIn instanceof EntityPlayer) {
            	Render3DUtils.drawNameplate(this.getFontRendererFromRenderManager(), entityIn, (float)x, (float)y + f2, (float)z, i, f, f1, flag1);
            }else {
