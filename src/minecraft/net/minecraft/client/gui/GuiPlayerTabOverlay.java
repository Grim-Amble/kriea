        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (flag)
                {
                    ...
                    boolean flag1 = entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.CAPE) && ("Dinnerbone".equals(gameprofile.getName()) || "ValrodClient".equals(gameprofile.getName()) || "Valrod".equals(gameprofile.getName()) || "Grumm".equals(gameprofile.getName()));
