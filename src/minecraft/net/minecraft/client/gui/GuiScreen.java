...
import me.valrod.client.ui.clickgui.ClickGuiButton;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public int height;
    protected List<ClickGuiButton> clickGuiButton = Lists.<ClickGuiButton>newArrayList();
    ...
    protected ClickGuiButton selectedButton2;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i = 0; i < this.clickGuiButton.size(); ++i)
        {
            ((ClickGuiButton)this.clickGuiButton.get(i)).draw(this.mc, mouseX, mouseY, partialTicks);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ...
            for (int i = 0; i < this.clickGuiButton.size(); ++i)
            {
            	ClickGuiButton guibutton = this.clickGuiButton.get(i);
