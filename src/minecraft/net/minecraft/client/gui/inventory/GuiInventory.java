...
//        float f4 = ent.rotationYawHead;
        ...
        float f = EventMotion.getYaw();
        float f1 = EventMotion.getYaw();
        float f2 = EventMotion.getPitch();
        float f3 = EventMotion.getPrevYaw();
        float f4 = EventMotion.getYaw();
        ...
        ent.rotationYawHead = EventMotion.getYaw();
        ent.prevRotationYawHead = EventMotion.getYaw();
