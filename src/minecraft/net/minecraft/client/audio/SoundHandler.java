...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    private void loadSoundResource(ResourceLocation location, SoundList sounds) throws Exception
    {
        ...
        for (final Sound sound : sounds.getSounds())
        {
            ...
            switch (sound.getType())
            {
                ...
                case SOUND_EVENT:
                    ...
                    break;
                default:
                    throw new Exception("Unknown SoundEventRegistration type: " + sound.getType());
            }
